...
//        team.addPlayer(new Person("kdsdf", "tsdfs", 46, 500));
//        team.addPlayer(new Person("bsdf", "jfss", 15, 600));
//
//        team.getReserveTeam().add(new Person("wsff", "hsfd", 15, 800));
//
//        System.out.println(team.getReserveTeam());
    }
}
